-- ============================================================
-- Da Enzo — RESET COMPLET DU MENU
-- Colle tout ce fichier dans Supabase SQL Editor et exécute
-- ============================================================

-- 1. Supprimer l'ancienne contrainte CHECK sur category
ALTER TABLE pizzas DROP CONSTRAINT IF EXISTS pizzas_category_check;
ALTER TABLE pizzas DROP CONSTRAINT IF EXISTS pizzas_category_check1;

-- 2. Corriger le DEFAULT et ajouter la bonne contrainte
...
('Tagliatelle alla carbonara', 'Guanciale, œuf, pecorino', 15.00, 'pasta', 'https://d8j0ntlcm91z4.cloudfront.net/user_34hTdMzSowzm7io1hBUuIclx78R/hf_20260609_145709_1e2961df-bd8f-420f-ac2b-7f831036030c.png', true, 27),
('Penne al 4 formaggi', 'Quatre fromages italiens, noix', 15.00, 'pasta', 'https://d8j0ntlcm91z4.cloudfront.net/user_34hTdMzSowzm7io1hBUuIclx78R/hf_20260609_145710_7c853269-0a1d-4a7b-bb06-2b5abac4bf9f.png', true, 28),
('Linguine al tartufo', 'Crème de truffe, champignons, parmesan', 19.00, 'pasta', 'https://d8j0ntlcm91z4.cloudfront.net/user_34hTdMzSowzm7io1hBUuIclx78R/hf_20260609_145711_171a4ddc-4019-442b-93a1-a02670d6bb57.png', true, 29),
('Risotto gorgonzola', 'Risotto crémeux au gorgonzola', 14.00, 'pasta', 'https://d8j0ntlcm91z4.cloudfront.net/user_34hTdMzSowzm7io1hBUuIclx78R/hf_20260609_145712_604a0695-e620-4cd1-a4d9-419f5424ab23.png', true, 30),
...
('Mousse au chocolat', 'Fait maison', 7.00, 'dolci', 'https://d8j0ntlcm91z4.cloudfront.net/user_34hTdMzSowzm7io1hBUuIclx78R/hf_20260609_150028_78ed0468-34a8-4946-9dae-fb73d68bba6d.png', true, 48),
('Crème brûlée', 'Fait maison', 7.00, 'dolci', 'https://d8j0ntlcm91z4.cloudfront.net/user_34hTdMzSowzm7io1hBUuIclx78R/hf_20260609_150029_29b2708c-3019-4e3b-bc48-09fdda6c014a.png', true, 49),
...
-- PICHETS & VERRE
('Pichet 25cl', 'Rouge / Rosé / Blanc', 7.00, 'vin', NULL, true, 68),
('Pichet 50cl', 'Rouge / Rosé / Blanc', 12.00, 'vin', NULL, true, 69),
('Bardolino au verre', 'Rouge ou Rosé', 5.50, 'vin', NULL, true, 70),
('Orvieto au verre', 'Blanc', 5.50, 'vin', NULL, true, 71);

-- 6. Vérification : affiche le nombre d'items par catégorie
